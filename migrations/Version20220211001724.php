 ...
 */
final class Version20220211001724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation_cand_format ADD motif_reclamation_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_FA25205F2211E980 ON reclamation_cand_format (motif_reclamation_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_FA25205F2211E980 ON reclamation_cand_format');
        $this->addSql('ALTER TABLE reclamation_cand_format DROP motif_reclamation_id');
    }
}
