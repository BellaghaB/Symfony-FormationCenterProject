 ...
 */
final class Version20220212123123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8F45EA96613FECDF ON inscri_formation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscri_formation ADD session_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE inscri_formation ADD CONSTRAINT FK_8F45EA96613FECDF FOREIGN KEY (session_id) REFERENCES session (id)');
        $this->addSql('CREATE INDEX IDX_8F45EA96613FECDF ON inscri_formation (session_id)');
